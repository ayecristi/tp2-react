...
export const crewData = {
  ayelen: {
    ...
    skills: [
      ...
      { name: "Figma", icon: "fa-brands fa-figma", level: 90 },
      { name: "Sass", icon: "fa-brands fa-sass", level: 80 }
    ],
    projects: [
      { id: 1, title: "Nebula UI Kit", img: "/img/project_01.jpg" },
      { id: 2, title: "Space E-Commerce", img: "/img/project_02.jpg" },
      { id: 3, title: "Galactic Dashboard", img: "/img/project_03.jpg" }
    ],
    socials: [
  ...
  lucio: {
    ...
    projects: [
      { id: 1, title: "API Interstelar", img: "/img/project_04.jpg" },
      { id: 2, title: "Gravity Router", img: "/img/project_05.jpg" },
      { id: 3, title: "Apollo Hooks", img: "/img/project_06.jpg" }
    ],
    socials: [
      { platform: "GitHub", icon: "fa-brands fa-github", url: "#" },
  ...
  matias: {
    ...
    projects: [
      { id: 1, title: "Meteor Data Sync", img: "/img/project_07.jpg" },
      { id: 2, title: "Cluster Manager", img: "/img/project_08.jpg" },
      { id: 3, title: "Orbit Auth Auth", img: "/img/project_09.jpg" }
    ],
    socials: [
      { platform: "GitHub", icon: "fa-brands fa-github", url: "#" },
      { platform: "LinkedIn", icon: "fa-brands fa-linkedin-in", url: "#" },
